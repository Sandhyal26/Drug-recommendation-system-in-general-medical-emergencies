...
* Built and trained classification models using Python and scikit-learn to map symptoms to recommended drugs.

* Applied feature engineering and model evaluation techniques to improve prediction accuracy.

* Implemented modular, reusable code following clean coding practices.
